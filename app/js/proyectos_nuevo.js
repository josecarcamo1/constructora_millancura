...
function crear_proyecto(){
    ...
    // Validación ingreso    
    if(data.cantidad <= 0){
        errores.push("La cantidad no puede ser menor a 1");
    }
    ...
    if(isNaN(data.estado_iva)){
        errores.push("Debe ingresar un estado de IVA");
    }

    if(data.nombre == ""){
        errores.push("Debe ingresar un nombre de pedido");
    }

    if(data.vendedor == ""){
        errores.push("Debe ingresar un vendedor");
    }
