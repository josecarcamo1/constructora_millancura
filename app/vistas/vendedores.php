    ...
    <body>
        ...
        <div class="container mt-3">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    <a href="vendedores_nuevo.php" class="btn btn-sm btn-primary" title="Nuevo Vendedor"><i class="fa fa-plus"></i></a>
                </div>
            </div>
        ...
        <script type="module" src="../js/vendedores.js?<?php echo time();?>"></script>
    </body>
</html>